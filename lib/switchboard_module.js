...
exports.createOwnedStateAccount = exports.setAuthConfigs = exports.createFulfillmentManagerAuth = exports.initFulfillmentManagerAuthAccount = exports.setFulfillmentManagerConfigs = exports.createFulfillmentManager = exports.initFulfillmentManagerAccount = exports.setDataFeedConfigs = exports.updateFeed = exports.removeFeedJob = exports.addFeedJob = exports.createDataFeed = exports.initDataFeedAccount = exports.publishSwitchboardAccount = exports.parseOracleJobAccountData = exports.parseFulfillmentAccountData = exports.parseAggregatorAccountData = exports.SWITCHBOARD_MAINNET_PID = exports.SWITCHBOARD_TESTNET_PID = exports.SWITCHBOARD_DEVNET_PID = void 0;
...
function parseFulfillmentAccountData(connection, address) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = accountInfo.data;
        if (data.length == 0 || data[0] != compiled_1.SwitchboardAccountType.TYPE_FULFILLMENT_MANAGER) {
...
function parseOracleJobAccountData(connection, address) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = accountInfo.data;
        if (data.length == 0 || data[0] != compiled_1.SwitchboardAccountType.TYPE_JOB_DEFINITION) {
            throw new Error(`Switchboard account parser was not provided with a fulfillment manager account: ${address.toBase58()}`);
        }
...
function updateFeed(connection, payerAccount, dataFeedPubkey, authKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return web3_js_1.sendAndConfirmTransaction(connection, new web3_js_1.Transaction()
 ...
 */
function createFulfillmentManager(connection, payerAccount, switchboardPid, accountSize = 5000) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function createFulfillmentManagerAuth(connection, payerAccount, fulfillmentManagerAccount, nomineePubkey, configs, accountSize = 5000) {
    return __awaiter(this, void 0, void 0, function* () {
        let fmAccountInfo = yield connection.getAccountInfo(fulfillmentManagerAccount.publicKey);
        if (fmAccountInfo == null) {
