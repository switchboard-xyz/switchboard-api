 ...
 */
function createVrfAccount(connection, payerAccount, switchboardPid, accountSize = 300) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let signature = yield web3_js_1.sendAndConfirmTransaction(connection, new web3_js_1.Transaction()
...
function requestRandomness(connection, payerAccount, vrfAccount, vrfProducerPermit, fmPermit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let transactionInstruction1 = new web3_js_1.TransactionInstruction({
            keys: [
                { pubkey: vrfAccount.publicKey, isSigner: true, isWritable: true },
                { pubkey: web3_js_1.SYSVAR_RECENT_BLOCKHASHES_PUBKEY, isSigner: false, isWritable: false },
