...
(function(global, factory) { /* global define, require, module */
    ...
    $root.Result = (function() {
         ...
         * @property {boolean|null} [completed] Result completed
         */
         ...
         * @instance
         */
        Result.prototype.completed = false;
    ...
    $root.RoundResult = (function() {
         ...
         * @property {Array.<IResult>|null} [results] RoundResult results
         */
        ...
        /**
         * RoundResult results.
         * @member {Array.<IResult>} results
         * @memberof RoundResult
         * @instance
         */
        RoundResult.prototype.results = $util.emptyArray;
        ...
        RoundResult.encode = function encode(message, writer) {
            ...
            if (message.results != null && message.results.length)
                for (var i = 0; i < message.results.length; ++i)
                    $root.Result.encode(message.results[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            return writer;
        };
        ...
        RoundResult.verify = function verify(message) {
            ...
            if (message.results != null && message.hasOwnProperty("results")) {
                ...
                for (var i = 0; i < message.results.length; ++i) {
                    var error = $root.Result.verify(message.results[i]);
                    if (error)
        ...
        RoundResult.fromObject = function fromObject(object) {
            ...
            if (object.results) {
                if (!Array.isArray(object.results))
                    throw TypeError(".RoundResult.results: array expected");
                message.results = [];
                for (var i = 0; i < object.results.length; ++i) {
                    if (typeof object.results[i] !== "object")
                        throw TypeError(".RoundResult.results: object expected");
