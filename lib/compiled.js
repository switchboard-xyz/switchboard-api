...
(function(global, factory) { /* global define, require, module */
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.JupiterSwapTask = (function() {
             ...
             * @instance
             */
            JupiterSwapTask.prototype.quoteAmount = 0;
            ...
            JupiterSwapTask.encode = function encode(message, writer) {
                ...
                if (message.quoteAmount != null && Object.hasOwnProperty.call(message, "quoteAmount"))
                    writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.quoteAmount);
                return writer;
            };
            ...
            JupiterSwapTask.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        message.quoteAmount = reader.uint32();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            JupiterSwapTask.verify = function verify(message) {
                ...
                if (message.quoteAmount != null && message.hasOwnProperty("quoteAmount"))
                    if (!$util.isInteger(message.quoteAmount))
                        return "quoteAmount: integer expected";
                return null;
            };
            ...
            JupiterSwapTask.toObject = function toObject(message, options) {
                ...
                if (message.outTokenAddress != null && message.hasOwnProperty("outTokenAddress"))
                    object.outTokenAddress = message.outTokenAddress;
                if (message.quoteAmount != null && message.hasOwnProperty("quoteAmount"))
                    object.quoteAmount = message.quoteAmount;
                return object;
            };
        ...
        OracleJob.SplStakePoolTask = (function() {
             ...
             * @property {OracleJob.SplStakePoolTask.Field|null} [field] SplStakePoolTask field
             */
             ...
             * @member {OracleJob.SplStakePoolTask.Field} field
             * @memberof OracleJob.SplStakePoolTask
             * @instance
             */
            SplStakePoolTask.prototype.field = 0;
            ...
            SplStakePoolTask.fromObject = function fromObject(object) {
                ...
                switch (object.field) {
                case "FIELD_TOKEN_VALUE":
                case 0:
                    message.field = 0;
                    break;
                case "FIELD_TOTAL_SUPPLY":
                case 1:
                    message.field = 1;
                    break;
                }
            ...
            SplStakePoolTask.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    object.pubkey = "";
                    object.field = options.enums === String ? "FIELD_TOKEN_VALUE" : 0;
                }
                if (message.pubkey != null && message.hasOwnProperty("pubkey"))
                    object.pubkey = message.pubkey;
                if (message.field != null && message.hasOwnProperty("field"))
                    object.field = options.enums === String ? $root.OracleJob.SplStakePoolTask.Field[message.field] : message.field;
                return object;
            };
            ...
            /**
             * Field enum.
             * @name OracleJob.SplStakePoolTask.Field
             * @enum {number}
             * @property {number} FIELD_TOKEN_VALUE=0 FIELD_TOKEN_VALUE value
             * @property {number} FIELD_TOTAL_SUPPLY=1 FIELD_TOTAL_SUPPLY value
             */
            SplStakePoolTask.Field = (function() {
                var valuesById = {}, values = Object.create(valuesById);
                values[valuesById[0] = "FIELD_TOKEN_VALUE"] = 0;
                values[valuesById[1] = "FIELD_TOTAL_SUPPLY"] = 1;
                return values;
            })();
