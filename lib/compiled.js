...
(function(global, factory) { /* global define, require, module */
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.LpTokenPriceTask = (function() {
             ...
             * @property {Array.<string>|null} [priceFeedAddress] LpTokenPriceTask priceFeedAddress
             */
             ...
             * @member {Array.<string>} priceFeedAddress
             * @memberof OracleJob.LpTokenPriceTask
             * @instance
             */
            LpTokenPriceTask.prototype.priceFeedAddress = $util.emptyArray;
            ...
            LpTokenPriceTask.encode = function encode(message, writer) {
                ...
                if (message.priceFeedAddress != null && message.priceFeedAddress.length)
                    for (var i = 0; i < message.priceFeedAddress.length; ++i)
                        writer.uint32(/* id 5, wireType 2 =*/42).string(message.priceFeedAddress[i]);
                return writer;
            };
            ...
            LpTokenPriceTask.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        if (!(message.priceFeedAddress && message.priceFeedAddress.length))
                            message.priceFeedAddress = [];
                        message.priceFeedAddress.push(reader.string());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            LpTokenPriceTask.verify = function verify(message) {
                ...
                if (message.priceFeedAddress != null && message.hasOwnProperty("priceFeedAddress")) {
                    if (!Array.isArray(message.priceFeedAddress))
                        return "priceFeedAddress: array expected";
                    for (var i = 0; i < message.priceFeedAddress.length; ++i)
                        if (!$util.isString(message.priceFeedAddress[i]))
                            return "priceFeedAddress: string[] expected";
                }
                return null;
            };
            ...
            LpTokenPriceTask.fromObject = function fromObject(object) {
                ...
                if (object.priceFeedAddress) {
                    if (!Array.isArray(object.priceFeedAddress))
                        throw TypeError(".OracleJob.LpTokenPriceTask.priceFeedAddress: array expected");
                    message.priceFeedAddress = [];
                    for (var i = 0; i < object.priceFeedAddress.length; ++i)
                        message.priceFeedAddress[i] = String(object.priceFeedAddress[i]);
                }
                return message;
            };
            ...
            LpTokenPriceTask.toObject = function toObject(message, options) {
                ...
                if (message.priceFeedAddress && message.priceFeedAddress.length) {
                    object.priceFeedAddress = [];
                    for (var j = 0; j < message.priceFeedAddress.length; ++j)
                        object.priceFeedAddress[j] = message.priceFeedAddress[j];
                }
                return object;
            };
