...
(function(global, factory) { /* global define, require, module */
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.LpTokenPriceTask = (function() {
             ...
             * @property {string|null} [baseFeedAddress] LpTokenPriceTask baseFeedAddress
             * @property {string|null} [quoteFeedAddress] LpTokenPriceTask quoteFeedAddress
             */
             ...
             * @member {string} baseFeedAddress
             * @memberof OracleJob.LpTokenPriceTask
             * @instance
             */
            LpTokenPriceTask.prototype.baseFeedAddress = "";
    
            /**
             * LpTokenPriceTask quoteFeedAddress.
             * @member {string} quoteFeedAddress
             * @memberof OracleJob.LpTokenPriceTask
             * @instance
             */
            LpTokenPriceTask.prototype.quoteFeedAddress = "";
            ...
            LpTokenPriceTask.encode = function encode(message, writer) {
                ...
                if (message.baseFeedAddress != null && Object.hasOwnProperty.call(message, "baseFeedAddress"))
                    writer.uint32(/* id 5, wireType 2 =*/42).string(message.baseFeedAddress);
                if (message.quoteFeedAddress != null && Object.hasOwnProperty.call(message, "quoteFeedAddress"))
                    writer.uint32(/* id 6, wireType 2 =*/50).string(message.quoteFeedAddress);
                return writer;
            };
            ...
            LpTokenPriceTask.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        message.baseFeedAddress = reader.string();
                        break;
                    case 6:
                        message.quoteFeedAddress = reader.string();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            LpTokenPriceTask.verify = function verify(message) {
                ...
                if (message.baseFeedAddress != null && message.hasOwnProperty("baseFeedAddress"))
                    if (!$util.isString(message.baseFeedAddress))
                        return "baseFeedAddress: string expected";
                if (message.quoteFeedAddress != null && message.hasOwnProperty("quoteFeedAddress"))
                    if (!$util.isString(message.quoteFeedAddress))
                        return "quoteFeedAddress: string expected";
                return null;
            };
            ...
            LpTokenPriceTask.fromObject = function fromObject(object) {
                ...
                if (object.baseFeedAddress != null)
                    message.baseFeedAddress = String(object.baseFeedAddress);
                if (object.quoteFeedAddress != null)
                    message.quoteFeedAddress = String(object.quoteFeedAddress);
                return message;
            };
            ...
            LpTokenPriceTask.toObject = function toObject(message, options) {
                ...
                var object = {};
                if (options.defaults) {
                    object.baseFeedAddress = "";
                    object.quoteFeedAddress = "";
                }
                if (message.mercurialPoolAddress != null && message.hasOwnProperty("mercurialPoolAddress")) {
                ...
                if (message.baseFeedAddress != null && message.hasOwnProperty("baseFeedAddress"))
                    object.baseFeedAddress = message.baseFeedAddress;
                if (message.quoteFeedAddress != null && message.hasOwnProperty("quoteFeedAddress"))
                    object.quoteFeedAddress = message.quoteFeedAddress;
                return object;
            };
