...
(function(global, factory) { /* global define, require, module */
    ...
    $root.RoundResult = (function() {
         ...
         * @property {Array.<number>|null} [responses] RoundResult responses
         */
        ...
        RoundResult.encode = function encode(message, writer) {
            ...
            if (message.responses != null && message.responses.length) {
                ...
                for (var i = 0; i < message.responses.length; ++i)
                    writer.double(message.responses[i]);
                writer.ldelim();
            }
            return writer;
        };
                ...
                case 8:
                    ...
                    if ((tag & 7) === 2) {
                        ...
                        while (reader.pos < end2)
                            message.responses.push(reader.double());
                    } else
                        message.responses.push(reader.double());
                    break;
                default:
        ...
        RoundResult.verify = function verify(message) {
            ...
            if (message.responses != null && message.hasOwnProperty("responses")) {
                ...
                for (var i = 0; i < message.responses.length; ++i)
                    if (typeof message.responses[i] !== "number")
                        return "responses: number[] expected";
            }
            return null;
        };
        ...
        RoundResult.fromObject = function fromObject(object) {
            ...
            if (object.responses) {
                ...
                for (var i = 0; i < object.responses.length; ++i)
                    message.responses[i] = Number(object.responses[i]);
            }
            return message;
        };
        ...
        RoundResult.toObject = function toObject(message, options) {
            ...
            if (message.responses && message.responses.length) {
                ...
                for (var j = 0; j < message.responses.length; ++j)
                    object.responses[j] = options.json && !isFinite(message.responses[j]) ? String(message.responses[j]) : message.responses[j];
            }
            return object;
        };
