...
(function(global, factory) { /* global define, require, module */
    ...
    $root.NodeResponse = (function() {
    
        /**
         * Properties of a NodeResponse.
         * @exports INodeResponse
         * @interface INodeResponse
         * @property {number|null} [result] NodeResponse result
         * @property {boolean|null} [completed] NodeResponse completed
         */
    
        /**
         * Constructs a new NodeResponse.
         * @exports NodeResponse
         * @classdesc Represents a NodeResponse.
         * @implements INodeResponse
         * @constructor
         * @param {INodeResponse=} [properties] Properties to set
         */
        function NodeResponse(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @instance
         */
        NodeResponse.prototype.result = 0;
         ...
         * @instance
         */
        NodeResponse.prototype.completed = false;
         ...
         * @static
         * @param {INodeResponse=} [properties] Properties to set
         * @returns {NodeResponse} NodeResponse instance
         */
        NodeResponse.create = function create(properties) {
            return new NodeResponse(properties);
        };
         ...
         * @memberof NodeResponse
         * @static
         * @param {INodeResponse} message NodeResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        NodeResponse.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
         ...
         * @returns {$protobuf.Writer} Writer
         */
        NodeResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {NodeResponse} NodeResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NodeResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.NodeResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NodeResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        NodeResponse.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {NodeResponse} NodeResponse
         */
        NodeResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.NodeResponse)
                return object;
            var message = new $root.NodeResponse();
         ...
         * @memberof NodeResponse
         * @static
         * @param {NodeResponse} message NodeResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        NodeResponse.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        NodeResponse.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.RoundResult = (function() {
         ...
         * @property {number|null} [mean] RoundResult mean
         ...
         * @property {Array.<INodeResponse>|null} [responses] RoundResult responses
         */
         ...
         * @member {Array.<INodeResponse>} responses
         * @memberof RoundResult
         * @instance
         */
        RoundResult.prototype.responses = $util.emptyArray;
        ...
        RoundResult.encode = function encode(message, writer) {
            ...
            if (message.responses != null && message.responses.length)
                for (var i = 0; i < message.responses.length; ++i)
                    $root.NodeResponse.encode(message.responses[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            return writer;
        };
            ...
            while (reader.pos < end) {
                ...
                case 8:
                    if (!(message.responses && message.responses.length))
                        message.responses = [];
                    message.responses.push($root.NodeResponse.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        RoundResult.verify = function verify(message) {
            ...
            if (message.responses != null && message.hasOwnProperty("responses")) {
                ...
                for (var i = 0; i < message.responses.length; ++i) {
                    var error = $root.NodeResponse.verify(message.responses[i]);
                    if (error)
        ...
        RoundResult.fromObject = function fromObject(object) {
            ...
            if (object.responses) {
                if (!Array.isArray(object.responses))
                    throw TypeError(".RoundResult.responses: array expected");
                message.responses = [];
                for (var i = 0; i < object.responses.length; ++i) {
                    if (typeof object.responses[i] !== "object")
                        throw TypeError(".RoundResult.responses: object expected");
                    message.responses[i] = $root.NodeResponse.fromObject(object.responses[i]);
                }
            }
            return message;
        };
        ...
        RoundResult.toObject = function toObject(message, options) {
            ...
            if (message.responses && message.responses.length) {
                ...
                for (var j = 0; j < message.responses.length; ++j)
                    object.responses[j] = $root.NodeResponse.toObject(message.responses[j], options);
            }
            return object;
        };
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.CcxtWsTask = (function() {
    
            /**
             * Properties of a CcxtWsTask.
             * @memberof OracleJob
             * @interface ICcxtWsTask
             * @property {string|null} [exchange] CcxtWsTask exchange
             * @property {string|null} [pair] CcxtWsTask pair
             */
    
            /**
             * Constructs a new CcxtWsTask.
             * @memberof OracleJob
             * @classdesc Represents a CcxtWsTask.
             * @implements ICcxtWsTask
             * @constructor
             * @param {OracleJob.ICcxtWsTask=} [properties] Properties to set
             */
            function CcxtWsTask(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * @memberof OracleJob.CcxtWsTask
             * @instance
             */
            CcxtWsTask.prototype.exchange = "";
             ...
             * @static
             * @param {OracleJob.ICcxtWsTask=} [properties] Properties to set
             * @returns {OracleJob.CcxtWsTask} CcxtWsTask instance
             */
            CcxtWsTask.create = function create(properties) {
                return new CcxtWsTask(properties);
            };
             ...
             * @memberof OracleJob.CcxtWsTask
             * @static
             * @param {OracleJob.ICcxtWsTask} message CcxtWsTask message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            CcxtWsTask.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                ...
                if (message.pair != null && Object.hasOwnProperty.call(message, "pair"))
                    writer.uint32(/* id 2, wireType 2 =*/18).string(message.pair);
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            CcxtWsTask.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {OracleJob.CcxtWsTask} CcxtWsTask
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CcxtWsTask.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.CcxtWsTask();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CcxtWsTask.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            CcxtWsTask.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
             ...
             * @returns {OracleJob.CcxtWsTask} CcxtWsTask
             */
            CcxtWsTask.fromObject = function fromObject(object) {
                if (object instanceof $root.OracleJob.CcxtWsTask)
                    return object;
                var message = new $root.OracleJob.CcxtWsTask();
             ...
             * @memberof OracleJob.CcxtWsTask
             * @static
             * @param {OracleJob.CcxtWsTask} message CcxtWsTask
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            CcxtWsTask.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults) {
             ...
             * @returns {Object.<string,*>} JSON object
             */
            CcxtWsTask.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
        ...
        OracleJob.Task = (function() {
             ...
             * @property {OracleJob.ICcxtWsTask|null} [ccxtWsTask] Task ccxtWsTask
             */
            ...
            /**
             * Task ccxtWsTask.
             * @member {OracleJob.ICcxtWsTask|null|undefined} ccxtWsTask
             * @memberof OracleJob.Task
             * @instance
             */
            Task.prototype.ccxtWsTask = null;
            ...
            /**
             * Task Task.
             * @member {"httpTask"|"jsonParseTask"|"medianTask"|"meanTask"|"websocketTask"|"ccxtWsTask"|undefined} Task
             * @memberof OracleJob.Task
             * @instance
             */
            Object.defineProperty(Task.prototype, "Task", {
                get: $util.oneOfGetter($oneOfFields = ["httpTask", "jsonParseTask", "medianTask", "meanTask", "websocketTask", "ccxtWsTask"]),
            ...
            Task.encode = function encode(message, writer) {
                ...
                if (message.ccxtWsTask != null && Object.hasOwnProperty.call(message, "ccxtWsTask"))
                    $root.OracleJob.CcxtWsTask.encode(message.ccxtWsTask, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                return writer;
            };
            ...
            Task.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        message.ccxtWsTask = $root.OracleJob.CcxtWsTask.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            Task.verify = function verify(message) {
                ...
                if (message.ccxtWsTask != null && message.hasOwnProperty("ccxtWsTask")) {
                    if (properties.Task === 1)
                        return "Task: multiple values";
                    properties.Task = 1;
                    {
                        var error = $root.OracleJob.CcxtWsTask.verify(message.ccxtWsTask);
                        if (error)
                            return "ccxtWsTask." + error;
                    }
                }
                return null;
            };
            ...
            Task.fromObject = function fromObject(object) {
                ...
                if (object.ccxtWsTask != null) {
                    if (typeof object.ccxtWsTask !== "object")
                        throw TypeError(".OracleJob.Task.ccxtWsTask: object expected");
                    message.ccxtWsTask = $root.OracleJob.CcxtWsTask.fromObject(object.ccxtWsTask);
                }
                return message;
            };
            ...
            Task.toObject = function toObject(message, options) {
                ...
                if (message.ccxtWsTask != null && message.hasOwnProperty("ccxtWsTask")) {
                    object.ccxtWsTask = $root.OracleJob.CcxtWsTask.toObject(message.ccxtWsTask, options);
                    if (options.oneofs)
                        object.Task = "ccxtWsTask";
                }
                return object;
            };
    ...
    $root.JobResult = (function() {
         ...
         * @property {Uint8Array|null} [jobPubkey] JobResult jobPubkey
         ...
         * @property {number|Long|null} [slot] JobResult slot
         * @property {number|Long|null} [timestamp] JobResult timestamp
         */
         ...
         * @instance
         */
        JobResult.prototype.jobPubkey = $util.newBuffer([]);
         ...
         * @instance
         */
        JobResult.prototype.slot = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        JobResult.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    ...
    $root.SwitchboardInstruction = (function() {
        ...
        SwitchboardInstruction.SaveResultInstruction = (function() {
             ...
             * @property {number|null} [jobIdx] SaveResultInstruction jobIdx
             * @property {number|null} [nodeIdx] SaveResultInstruction nodeIdx
             * @property {Uint8Array|null} [jobPubkey] SaveResultInstruction jobPubkey
             ...
             * @member {number} jobIdx
             * @memberof SwitchboardInstruction.SaveResultInstruction
             * @instance
             */
            SaveResultInstruction.prototype.jobIdx = 0;
             ...
             * @instance
             */
            SaveResultInstruction.prototype.jobPubkey = $util.newBuffer([]);
            ...
            SaveResultInstruction.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.jobIdx != null && Object.hasOwnProperty.call(message, "jobIdx"))
                    writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.jobIdx);
                ...
                if (message.jobPubkey != null && Object.hasOwnProperty.call(message, "jobPubkey"))
                    writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.jobPubkey);
                if (message.result != null && Object.hasOwnProperty.call(message, "result"))
            ...
            SaveResultInstruction.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.jobIdx != null && message.hasOwnProperty("jobIdx"))
                    if (!$util.isInteger(message.jobIdx))
                        return "jobIdx: integer expected";
            ...
            SaveResultInstruction.fromObject = function fromObject(object) {
                ...
                if (object.jobIdx != null)
                    message.jobIdx = object.jobIdx >>> 0;
