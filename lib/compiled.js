...
(function(global, factory) { /* global define, require, module */
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.TwapTask = (function() {
             ...
             * @property {boolean|null} [weightByPropogationTime] TwapTask weightByPropogationTime
             */
             ...
             * @member {boolean} weightByPropogationTime
             * @memberof OracleJob.TwapTask
             * @instance
             */
            TwapTask.prototype.weightByPropogationTime = false;
            ...
            TwapTask.encode = function encode(message, writer) {
                ...
                if (message.weightByPropogationTime != null && Object.hasOwnProperty.call(message, "weightByPropogationTime"))
                    writer.uint32(/* id 3, wireType 0 =*/24).bool(message.weightByPropogationTime);
                return writer;
            };
            ...
            TwapTask.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        message.weightByPropogationTime = reader.bool();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            TwapTask.verify = function verify(message) {
                ...
                if (message.weightByPropogationTime != null && message.hasOwnProperty("weightByPropogationTime"))
                    if (typeof message.weightByPropogationTime !== "boolean")
                        return "weightByPropogationTime: boolean expected";
                return null;
            };
            ...
            TwapTask.fromObject = function fromObject(object) {
                ...
                if (object.weightByPropogationTime != null)
                    message.weightByPropogationTime = Boolean(object.weightByPropogationTime);
                return message;
            };
            ...
            TwapTask.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.period = 0;
                    object.weightByPropogationTime = false;
                }
                if (message.aggregatorPubkey != null && message.hasOwnProperty("aggregatorPubkey"))
                    object.aggregatorPubkey = message.aggregatorPubkey;
                if (message.period != null && message.hasOwnProperty("period"))
                ...
                if (message.weightByPropogationTime != null && message.hasOwnProperty("weightByPropogationTime"))
                    object.weightByPropogationTime = message.weightByPropogationTime;
                return object;
            };
