...
(function(global, factory) { /* global define, require, module */
    ...
    $root.FulfillmentAgreement = (function() {
        ...
        FulfillmentAgreement.fromObject = function fromObject(object) {
            ...
            if (object.completed != null)
                if (typeof object.completed === "string")
    ...
    $root.OracleJob = (function() {
        ...
        OracleJob.HttpTask = (function() {
             ...
             * @property {string|null} [stringifiedBody] HttpTask stringifiedBody
             */
             ...
             * @member {string} stringifiedBody
             * @memberof OracleJob.HttpTask
             * @instance
             */
            HttpTask.prototype.stringifiedBody = "";
            ...
            HttpTask.encode = function encode(message, writer) {
                ...
                if (message.stringifiedBody != null && Object.hasOwnProperty.call(message, "stringifiedBody"))
                    writer.uint32(/* id 4, wireType 2 =*/34).string(message.stringifiedBody);
                return writer;
            };
            ...
            HttpTask.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.stringifiedBody = reader.string();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            HttpTask.verify = function verify(message) {
                ...
                if (message.stringifiedBody != null && message.hasOwnProperty("stringifiedBody"))
                    if (!$util.isString(message.stringifiedBody))
                        return "stringifiedBody: string expected";
                return null;
            };
            ...
            HttpTask.fromObject = function fromObject(object) {
                ...
                if (object.stringifiedBody != null)
                    message.stringifiedBody = String(object.stringifiedBody);
                return message;
            };
            ...
            HttpTask.toObject = function toObject(message, options) {
                ...
                if (message.stringifiedBody != null && message.hasOwnProperty("stringifiedBody"))
                    object.stringifiedBody = message.stringifiedBody;
                return object;
            };
